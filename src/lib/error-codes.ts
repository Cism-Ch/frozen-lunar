...
export const DB_ERRORS = {
    ...
    UNIQUE_CONSTRAINT: {
        ...
        solution:
            "Vérifiez que les données sont uniques (email, identifiant, etc.)",
        httpStatus: 409,
    },
    RECORD_NOT_FOUND: {
        code: "DB004",
...
export const AUTH_ERRORS = {
    ...
    INVALID_ROLE: {
        ...
        solution:
            "Contactez un administrateur pour obtenir les bonnes permissions",
        httpStatus: 403,
    },
} as const;
...
export const VALIDATION_ERRORS = {
    INVALID_EMAIL: {
        ...
        solution:
            "Entrez une adresse email valide (ex: utilisateur@example.com)",
        httpStatus: 400,
    },
    WEAK_PASSWORD: {
        code: "VAL002",
