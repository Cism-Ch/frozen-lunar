...
export const services: ServiceItem[] = [
    {
        ...
        description:
            "Livraison rapide de matériaux de construction sur vos chantiers.",
        icon: Box,
    },
    {
        title: "Transport de Containers",
        description:
            "Solutions adaptées pour le déplacement de containers maritimes et de stockage.",
        icon: Warehouse,
    },
    {
        title: "Transport de Charpentes",
        description:
            "Transport spécialisé pour charpentes bois et métalliques de grandes dimensions.",
        icon: HomeIcon,
    },
    {
        title: "Transport de Machines",
        description:
            "Déplacement sécurisé de machines industrielles et engins de chantier.",
        icon: Hammer,
    },
    {
        title: "Modules Préfabriqués",
        description:
            "Logistique complète pour l'acheminement de modules et bungalows.",
        icon: Truck,
    },
];
